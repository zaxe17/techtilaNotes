                ...
                <form action="" method="POST">
                    ...
                    if (isset($registerError)) {
                        foreach ($registerError as $registerError) {
                            echo '<span class="error-msg animation" style="--i: 1; --j: 16;"><i class="bx bxs-error-circle"></i>' . $registerError . '</span>';
                        };
                    }

                    if (isset($message)) {
                        foreach ($message as $message) {
                            echo '<span class="error-msg animation" style="--i: 1; --j: 16;"><i class="bx bxs-error-circle"></i>' . $message . '</span>';
                        };
                    }
                    ?>
